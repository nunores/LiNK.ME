...
Route::post('api/user/picture', 'UserController@changePicture')->name("changePicture");
...
Route::get('api/posts/{general}', 'PostController@postOrder');
Route::get('api/more_posts', 'PostController@morePosts');
...
//Comments
Route::get('api/comment', 'CommentController@showCommentsFromPost'); // Not used
