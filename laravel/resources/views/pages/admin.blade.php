    ...
    <div class="row">
        ...
        <div class="col-8">
            <div id="center-col">
                ...
                @endforeach
                <svg id="load-more" data-login="{{ Auth::check() && !Auth::user()->is_admin }}" data-page-id="1" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chevron-compact-down" viewBox="0 0 16 16">
