<div class="comment">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-1 three-dots post-comment-div collapsed" type="link" data-bs-toggle="collapse" data-bs-target="#comment-options-{{ $comment->id }}" aria-expanded="false" aria-controls="comment-options">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                    <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" />
                </svg>
            </div>
            <div id="comment-options-{{ $comment->id }}" data-admin="{{ Auth::user()->is_admin }}" data-comment-id="{{ $comment->id }}" data-post-id="{{ $comment->post->id }}" class="comment-options collapse">
