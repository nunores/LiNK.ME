			...
			<div class="post-icons">
				<div class="row align-items-center">
					...
					<div class="col-2">
						<div id="post-like">
							@if ($likes === true)
                                <svg style="color: var(--green);" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
							...
							<span id="number-likes"> {{ count($post->likes->where('likes', '=', true)) }} </span>
						</div>
					</div>
					<div class="col-2">
						<div id="post-dislike">
							@if ($likes === false)
								<svg style="color: var(--pink);" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
							...
							@endif
							<span id="number-dislikes"> {{ count($post->likes->where('likes', '=', false)) }} </span>
						</div>
					</div>
					<div class="col">
